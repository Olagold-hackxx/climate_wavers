  ...
  return (
    <div className="lg:h-[100vh] md:h-[100vh] flex justify-between">
      ...
      <div className="w-[100%] lg:w-[35%] md:w-[50%] py-8 lg:px-16 md:px-16 px-6 m-auto text-center">
        ...
        <p className="lg:text-[24px] md:text-[24px] text-[18px] font-serif mb-10">Input Email to receive reset password code</p>
         <TextField
            id="outlined-basic"
            label="Email"
            sx={{ m: 1, width: "100%" }}
            ...
            color="success"
          />
        <button className="bg-[#047857]  rounded-md text-white py-4 w-[100%] m-2 mt-4" onClick={() => navigate('/emailcode')}>Confirm</button>
